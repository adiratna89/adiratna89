...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Matplotlib-0C4B8E?style=flat-square&logo=plotly&logoColor=white"/>
  <img src="https://img.shields.io/badge/Seaborn-4E9BCD?style=flat-square&logo=python&logoColor=white"/>
...
- **🧠 MNIST ANN Digit Classification** — `Deep Learning` `TensorFlow` `Keras`
...
- **🏦 Bank Loan Approval Prediction** — `Machine Learning` `Classification` `AUC`
...
- **🛒 Sales Data Analysis** — `Python` `Pandas` `Visualization`
